...
cvx_problems = [
    ...
    "clay0304hfsg.mod",
    "clay0305hfsg.mod",
    "cvxnonsep_normcon20.mod",
    "cvxnonsep_normcon30.mod",
    "cvxnonsep_normcon40.mod",
    "cvxnonsep_nsig20.mod",
    "cvxnonsep_nsig20r.mod",
    "cvxnonsep_nsig30.mod",
    "cvxnonsep_nsig30r.mod",
    "cvxnonsep_nsig40.mod",
    "cvxnonsep_nsig40r.mod",
    "cvxnonsep_pcon20.mod",
    "cvxnonsep_pcon20r.mod",
    "enpro48pb.mod",
    "enpro56pb.mod",
    "ex1223.mod",
    "ex1223b.mod",
    ...
    "o8_ar4_1.mod",
    "o9_ar4_1.mod",
    "p_ball_10b_5p_2d_h.mod",
    "p_ball_10b_5p_3d_h.mod",
    "p_ball_10b_5p_4d_h.mod",
    "p_ball_10b_7p_3d_h.mod",
    "p_ball_15b_5p_2d_h.mod",
    "p_ball_20b_5p_2d_h.mod",
    "p_ball_20b_5p_3d_h.mod",
    "p_ball_30b_5p_2d_h.mod",
    "portfol_buyin.mod",
    "portfol_card.mod",
    "portfol_roundlot.mod",
    "prob10.mod",
    "ravempb.mod",
    "sssd08-04.mod",
    "sssd12-05.mod",
...
noncvx_problems = [
    "4stufen.mod",
    "autocorr_bern20-05.mod",
    "autocorr_bern20-10.mod",
    "autocorr_bern20-15.mod",
    "autocorr_bern25-06.mod",
    "autocorr_bern25-13.mod",
    "autocorr_bern25-19.mod",
    "autocorr_bern25-25.mod",
    "autocorr_bern30-04.mod",
    "autocorr_bern30-08.mod",
    "autocorr_bern30-15.mod",
    "autocorr_bern30-23.mod",
    "autocorr_bern30-30.mod",
    "autocorr_bern35-04.mod",
    "autocorr_bern35-09.mod",
    "autocorr_bern35-18.mod",
    "autocorr_bern35-26.mod",
    "autocorr_bern35-35fix.mod",
    "autocorr_bern40-05.mod",
    "autocorr_bern40-10.mod",
    "autocorr_bern40-20.mod",
    "autocorr_bern40-30.mod",
    "autocorr_bern40-40.mod",
    "autocorr_bern45-05.mod",
    "autocorr_bern45-11.mod",
    "autocorr_bern45-23.mod",
    "autocorr_bern45-34.mod",
    "autocorr_bern45-45.mod",
    "autocorr_bern50-06.mod",
    "autocorr_bern50-13.mod",
    "autocorr_bern50-25.mod",
    "autocorr_bern55-06.mod",
    "autocorr_bern55-14.mod",
    "autocorr_bern60-08.mod",
    "autocorr_bern60-15.mod",
    "batch0812_nc.mod",
    "batch_nc.mod",
    "beuster.mod",
    "casctanks.mod",
    ...
    "st_e38.mod",
    "st_e40.mod",
    "supplychainp1_020306.mod",
    "supplychainr1_020306.mod",
    "supplychainr1_030510.mod",
    "synheat.mod",
    "tanksize.mod",
    "transswitch0009p.mod",
    "transswitch0009r.mod",
    "transswitch0014p.mod",
    "transswitch0014r.mod",
    "transswitch0030p.mod",
    "transswitch0030r.mod",
    "transswitch0039p.mod",
    "transswitch0039r.mod",
    "tspn05.mod",
    "tspn08.mod",
    "tspn10.mod",
    "tspn12.mod",
    ...
    "waterno2_02.mod",
    "waterno2_03.mod",
    "watertreatnd_conc.mod",
    "watertreatnd_flow.mod",
    "waterx.mod",
    "waterz.mod",
    "windfac.mod",
]
...
for problem in problems[i_start:]:
    ...
    if (
        ...
        ampl.eval(
            f'option {solver}_options "bestbound=1" "round_reptol=1e-3" "feastol=1e-8" "mipgap=1e-2" "maxnthreads=1" "timelimit={time_limit}";'
        )  # "outlev 1"
    elif solver == "xpress":
        ampl.eval(
            f'option {solver}_options "bestbound=1" "intfeastol=1e-3" "feastol=1e-8" "mipgap=1e-2" "threads=1" "timelimit={time_limit}";'
        )  # "outlev 1"
